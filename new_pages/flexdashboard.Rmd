...
このページでは、**flexdashboard** パッケージの基本的な使い方を解説します。このパッケージは、R Markdon のアウトプットをパネルやページで構成されたダッシュボードに簡単にすることができます。ダッシュボードの内容は、文章、静的な図表、あるいはインタラクティブな図表とすることができます。
...
* スタンダードではない R のコードが最小限で済みます ― 少し練習するだけで、ダッシュボードをすぐにつくることができます。
