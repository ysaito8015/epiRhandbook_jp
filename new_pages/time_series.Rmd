...
# 時系列とアウトブレイクの検出{# Time series and outbreak detection}
...
主に[**tidyverts**]（https://tidyverts.org/）ファミリーのパッケージを使用していますが、感染症疫学に適したモデルをフィットさせるために、RECON [**trending**]（https://github.com/reconhub/trending）パッケージも使用しています。
